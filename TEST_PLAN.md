...
| TC-CCD-013 | Rotated moving obstacle relative CCD | CCD handles moving rotated obstacle via relative motion | Rotated obstacle with velocity toward mover; rotated fast mover; `fixedUpdate(0.05)` | Body clamped near obstacle (no tunneling) |
